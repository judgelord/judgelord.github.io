...
```{r guidance}
d <- readxl::read_excel(here("content/research/guidance/Guidance Output.xlsx"), range = "Main Results!A6:S56")
...
(Experimental Data)"
d <- readxl::read_excel(here("content/research/guidance/Guidance Output.xlsx"), range = "Experiment!A6:O41")
...
data <- "Estimates of Hypothetical Influence
(Experimental Data)"
d <- readxl::read_excel(here("content/research/guidance/out/OutputA.xlsx"), 
                        range = "Sheet1!A1:C4") %>% 
  mutate(model = "Model A, General Influence",
         term = B_1A) %>% 
  full_join(readxl::read_excel(here("content/research/guidance/out/OutputC.xlsx"), 
                               range = "Sheet1!A1:C4") %>% 
              mutate(model = "Model C, Public Interest Group Influence",
                     term = B_1B) ) %>% 
  full_join(readxl::read_excel(here("content/research/guidance/out/OutputE.xlsx"), 
                               range = "Sheet1!A1:C4") %>%
