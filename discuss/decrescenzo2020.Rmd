...
Mike has clearly thought about this so carefully that I sincerely doubt that I can offer anything thing that pushes the thinking in any way. 
My comments are really about framing. 
...
BUT, we have yet to observe the preferences of local partisans.
...
1. local partisan voters'
1. policy preferences/ideologies
1. are represented in/transmitted into government

Implication: If primaries work, a district's partizans' preferences should affect
...
**Naming things!** 🤔"district-party publics" vs "district-party groups" vs "partisan constituency" --> "the ideology of a district's partizans" 🤷 
...
A) Policy items <-> *Grey area* <-> Not policy items

--

B) You down-weight repeated observations from an individual ✓
1. Would have no effect if everyone is asked 20 questions, correct? 
1. Same as up-weighting responses to shorter surveys? 
1. Reasonable weight bounds: We learn more from a 20-question survey than a 10-question survey, but not as much as two 10-question surveys. Can you test or sample weights in that range? 
--
...
**DIME ~ Strategic candidate positioning?** 
If not, not so informative regarding the strategic positioning dilemma per se (but this is fine)

**DIME ~ Credible candidate policy commitments?** 
...
A district's past vote share likely influences candidate positions (and decisions to run). However, it may do so primarily *because* primaries exist. Thus,
1. If the effect of ideology is 100% mediated, primaries might still "work," and thus, the total effect may be more relevant.
1. What we really want to block is the portion of the effect of past presidential vote share that is *not* due to its signal of district ideology (i.e., the mediated effect). The way you calculated the average total effect does this, right?  It is just a matter of emphasis on what is blocked and why. 
...
# Related questions about representation

Under what conditions do a district's partizans policy preferences diverge from the policy preferences (donation patterns) of candidate slate? 

--

## Mediation

Under what conditions do the ideologies of a district's partizans *not* determine their vote choice? 

1. not all district partizans vote
1. voters choose candidates for reasons other than policy positions measured on surveys
1. ?

---

background-image: url(metaphysics.gif)
