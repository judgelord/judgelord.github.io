...
- Or expierence $\times$ GOP $\times$ open seat?
...
- Or expierence $\times$ money $\times$ GOP $\times$ open seat?
...
Which intereactions?
- [ ] # of candidates $\times$ party
- [ ] 2+ expierenced candidates $\times$ party
- [ ] 60+% president vote $\times$ party
- [x] South $\times$ party
- [?] Total money $\times$ party
- [  ] Closed Primary $\times$ party
- [?] Redistricting $\times$ party
