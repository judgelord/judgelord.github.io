...
- Pg. 11: It would be interesting to see figures 1 and 2 with the 3-category definition. 
...
- Pg. 25: I don't see how Table 2 shows that the "probability of winning a primary election for candidates who had previously held elected office was 83 percent"--a figure might be better. If these are just predicted probabilities, then holding fundraising at $0 seems odd. The mean or mode (as you do for the predicted effects of money) seems more standard.
...
- Table 2: I wonder if the interaction "inexpierence*pac fundraising" is the interaction you want to test. You find a weak negative effect for experience x money, but the theory is more about inexperience x money, and I am not sure that these two interactions test the same thing.
...
- Figure 7a might be more striking if the later periods were presented relative to the early baseline, drawing attention to the shift. Again, unlogged x-axis labels would be helpful.
